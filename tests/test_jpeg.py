...
class NdpiTilerJpegTest(unittest.TestCase):
    ...
    def test_huffman_node(self):
        root = HuffmanNode(0)
        self.assertTrue(root.insert(HuffmanLeaf(1), 0))
        self.assertTrue(root.insert(HuffmanLeaf(2), 0))
        self.assertFalse(root.insert(HuffmanLeaf(3), 0))
        self.assertFalse(root.insert(HuffmanLeaf(4), 1))

        root = HuffmanNode(0)
        self.assertTrue(root.insert(HuffmanLeaf(1), 0))
        self.assertTrue(root.insert(HuffmanLeaf(2), 1))
        self.assertTrue(root.insert(HuffmanLeaf(3), 1))
        self.assertFalse(root.insert(HuffmanLeaf(4), 1))

        root = HuffmanNode(0)
        self.assertTrue(root.insert(HuffmanLeaf(1), 0))
        self.assertTrue(root.insert(HuffmanLeaf(2), 1))
        self.assertTrue(root.insert(HuffmanLeaf(3), 2))
        self.assertTrue(root.insert(HuffmanLeaf(4), 2))
        self.assertFalse(root.insert(HuffmanLeaf(5), 2))
    ...
    def test_huffman_node_insert_into_self(self):
        root = HuffmanNode(0)
        self.assertTrue(root._insert_into_self(HuffmanLeaf(1), 0))
        self.assertFalse(root._insert_into_self(HuffmanLeaf(2), 1))
        self.assertTrue(root._insert_into_self(HuffmanLeaf(3), 0))
        self.assertFalse(root._insert_into_self(HuffmanLeaf(4), 0))
    ...
    def test_huffman_node_insert_into_child(self):
        ...
        self.assertTrue(root._insert_into_child(HuffmanLeaf(1), 1))
        self.assertTrue(root._insert_into_child(HuffmanLeaf(2), 1))
        self.assertTrue(root._insert_into_child(HuffmanLeaf(3), 1))
        self.assertTrue(root._insert_into_child(HuffmanLeaf(4), 1))
        self.assertFalse(root._insert_into_child(HuffmanLeaf(5), 1))

    def test_huffman_node_insert_into_new_child(self):
        root = HuffmanNode(0)
        self.assertTrue(root._insert_into_new_child(HuffmanLeaf(1), 1))
        self.assertTrue(root._insert_into_new_child(HuffmanLeaf(2), 1))
        self.assertFalse(root._insert_into_new_child(HuffmanLeaf(3), 1))
