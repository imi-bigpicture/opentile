...
def create_small_header_bytes() -> bytes:
    return bytes([
        ...
        0x50, 0x00, 0x00, 0xFF, 0xEE, 0x00, 0x0E, 0x41, 0x64, 0x6F, 0x62, 0x65,
        ...
        0x11, 0x08, 0x00, 0x08, 0x00, 0x10, 0x03, 0x01, 0x11, 0x00, 0x02, 0x11,
        0x01, 0x03, 0x11, 0x01, 0xFF, 0xC4, 0x01, 0xA2, 0x00, 0x00, 0x00, 0x07,
...
def create_small_set() -> Tuple[JpegHeader, JpegScan, bytes]:
    header = JpegHeader(create_small_header_bytes())
...
def create_large_set(tif: TiffFile) -> Tuple[JpegHeader, JpegScan, bytes]:
    page = get_page(tif)
    header = JpegHeader(page.jpegheader)
